...
- **Кроссбраузерность** К сожалению, разработчики браузеров далеко не всегда следуют официальной спецификации [W3C](https://www.w3.org/) (консорциум, который занимается поддержкой и развитием HTML и CSS, именно они решают какие HTML теги и CSS свойства добавлять в новых версиях, и именно они описывают, как это всё должно работать), поэтому одна и та же верстка в разных браузерах может выглядеть совершенно по разному, нужно стараться приводить верстку к одному виду во всех браузерах (**но в пределах разумного, идельной точности в разных браузерах добиться практически невозможно, да и в 99,9% случаев - бессмысленно**). [Тут](https://youtu.be/ANyRXCEcBUM) можно посмотреть некоторые примеры различий работы одних и тех же CSS свойств в разных браузеров и способы их пофиксить.
